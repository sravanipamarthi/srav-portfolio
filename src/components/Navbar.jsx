    ...
    >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
            <motion.div
                ...
                className="flex iems-center space-x-2"
            >
                <Code2 size={24} className="text-[#7B3F00]" />{" "}
                <span className="text-lg ml-1 text-[#B35C00]">Sravani Pamarthi</span>
            </motion.div>
            ...
            <div className="md:hidden flex items-center space-x-4">
                ...
                <motion.button
                    ...
                    className={`p-2 rounded-full transition-colors ${
                        isDarkMode ? "text-gray-400 hover:ext-white hover:bg-gray-800" : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"
                    }`}
                >
