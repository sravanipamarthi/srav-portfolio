        ...
        <div className="absolute top-0 left-0 w-full h-px overflow-hidden ">
            <motion.div
                className={`h-px bg-gradient-to-r ${
                    isDarkMode ?
                    "from-transparent via-[#B35C00] to-transparent"
                    : "from-transparent via-[#7B3F00] to-transparent"
                }`}
            ...
            <motion.div
                className={`absolute top-0 h-px w-32 bg-gradient-to-r ${
                    isDarkMode
                    ? "from-[#B35C00] via-[#D6C7B1] to-[#B35C00]"
                    : "from-[#7B3F00] via-[#5C2F00] to-[#7B3F00]"
                } blur-sm `}
                animate= {{ 
                    x: ['-50%', 'calc(100vw + 50%)'],
                }}
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="space-y-2" >
                            <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-600"}`}>
                                © {new Date().getFullYear()} Sravani Pamarthi. All rights reserved. 
                            </p>
