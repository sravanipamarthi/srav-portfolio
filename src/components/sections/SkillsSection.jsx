    ...
    >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
                ...
                >
                    Skills &
                    <span className="text-[#7B3F00] font-medium">Technologies</span>
                </motion.h2>
                ...
                >
                    ...
                    applications from concept to deployement.
                </motion.p>
            </motion.div>
                ...
                {SKILLS_CATEGORY.map((category, categoryIndex) => (
                    ...
                    >
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            >
                                <category.icon size={24} className="text-[#7B3F00]" />
                            </div>
                            <div>
                            ...
                            {category.skills.map((skill, skillIndex) => (
                                <div key={skill.name} className="group">
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <span 
                                            className={`text-xs ${
                                                isDarkMode ? "text-gray-500" : "tex-gray-600"
                                            }`}
                                        >
                                            {skill.level}%
                                        </span>
            ...
            >
                {STATS.map((stat, index) => (
                    ...
                    >
                        <div className="text-2xl md:text-3xl font-light text-[#7B3F00] mb-2" >
                            {stat.number}
                        </div>
                        <div 
                            className={`text-sm ${
